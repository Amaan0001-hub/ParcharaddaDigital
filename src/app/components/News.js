const News = () => {
  const newsItems = [
    {
      ...
      comments: 0,
      authorImage: "/img/client-img.png",
  ...
  return (
    <section className="relative overflow-hidden section-padding bg-gray-50">
      {/* Background Shape */}
      <img
              ...
              <div className="pt-6 pb-4">
                ...
                <div className="flex flex-col gap-4 mb-4 text-sm text-gray-500">
                  <span className="flex items-center gap-2">
                    <svg className="w-4 h-4" fill="#6A47ED" viewBox="0 0 16 16">
                ...
                {/* Title */}
                <h5 className="mb-6 text-xl font-bold transition-colors group-hover:text-primary">
