...
const Footer = () => {
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <p className="mb-6 text-gray-400">
              Boost your brand with expert Social Media Management, targeted ADS Management, and compelling Branding & Identity Design services.
            </p>
  ...
  {[
    ...
    { 
      name: "instagram", 
      url: "https://www.instagram.com/prachaaradda?igsh=MWs2eHYxeTJ2cXliZA==",
      color: "hover:bg-gradient-to-r hover:from-[#833AB4] hover:via-[#FD1D1D] hover:to-[#FCB045] hover:border-transparent",
      iconColor: "text-white group-hover:text-white"
    }
  ].map((social) => (
    <a
      ...
      className={`group flex items-center justify-center w-10 h-10 transition-all duration-300 bg-transparent border border-white rounded-full ${social.color}`}
      aria-label={`Visit our ${social.name} page`}
    >
      <svg
        className={`w-5 h-5 ${social.iconColor}`}
        fill="currentColor"
        viewBox="0 0 24 24"
      >
