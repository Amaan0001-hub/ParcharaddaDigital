...
export default function ServicesPage() {
  return (
    <div>
      ...
      <div className="py-20 bg-white">
        <div className="container px-4 mx-auto mb-12">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            <div className="px-4 py-8 transition-shadow border flex gap-3 duration-300 bg-white shadow rounded-2xl hover:shadow-xl group">
              <div className="mb-6">
                <img
                  src="/img/icon-1.png"
            ...
            <div className="relative col-span-1">
              <div className="flex items-center p-10 gap-[30px] rounded-2xl bg-[#9578ff33]">
                <div className="rounded-[10px] bg-white max-w-[295px] p-[30px]">
                  ...
                  <h3 className="text-lg font-semibold mb-2">Total Project</h3>
      ...
      <Pricing />
      <div className="testimonial-bg py-20">
        <div className="container px-4 mx-auto">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-2">
            <div className="col-span-1">
              <div className="testimonial-image flex justify-center text-center relative z-10">
              ...
              <div className="relative bg-white rounded-2xl border border-[#DDE0E9] px-[30px] py-[40px] mt-[50px] max-w-[585px]">
                <div className="flex items-center gap-[10px] mb-5">
                  ...
                  <div className="content-client">
                    <h4 className="font-semibold text-xl">Sarah Taylor</h4>
